                ...
                <div className="flex gap-2">
                 ...
                 <div>
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                    <h5 className="text-sm font-medium text-gray-900 mb-2">Property Summary</h5>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div>
                        <span className="text-gray-600">List Price:</span>
                        <span className="ml-2 font-medium">{formatValue(selectedProperty['List Price'], 'List Price')}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Close Price:</span>
                        <span className="ml-2 font-medium">{formatValue(selectedProperty['Close Price'], 'Close Price')}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Square Feet:</span>
                        <span className="ml-2 font-medium">{formatValue(selectedProperty['Above Grade Finished SQFT'], 'Above Grade Finished SQFT')}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Price/SqFt:</span>
                        <span className="ml-2 font-medium">{formatValue(selectedProperty['Price/SqFt'], 'Price/SqFt')}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Beds:</span>
                        <span className="ml-2 font-medium">{selectedProperty['Beds']}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Baths:</span>
                        <span className="ml-2 font-medium">{selectedProperty['Baths']}</span>
                      </div>
                    </div>
                  </div>
                </div>
